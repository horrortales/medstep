            ...
            <SafeAreaView className="flex-1">
                ...
                <View className="flex-1 justify-center items-center px-6 pb-8">
                    ...
                    <Animated.View
                        ...
                        className="items-center mb-8"
                    >
                        <Text className="text-4xl font-poppins-bold text-white mb-6 text-center">
                            Welcome to Excellence
                        </Text>
                        <Text className="text-xl font-poppins text-white text-center leading-5 px-4 mb-10">
                    ...
                    <Animated.View
                        ...
                        className="px-6 mb-6"
                    >
                        <Text className="text-xs font-poppins text-white text-center leading-4 mb-20">
                            By continuing, you agree to our{' '}
                            <Text className="text-white font-poppins-medium">Terms of Service</Text>
                            {' '}and{' '}
                            <Text className="text-white font-poppins-medium">Privacy Policy</Text>
                        </Text>
                    </Animated.View>
                    ...
                    >
                        <View className="items-center">
                            ...
                            <Text className="text-xs font-poppins text-white ">10K+ MCQs</Text>
                        </View>
                        ...
                        <View className="items-center">
                            ...
                            <Text className="text-xs font-poppins text-white ">Track Progress</Text>
                        </View>
                        ...
                        <View className="items-center">
                            ...
                            <Text className="text-xs font-poppins text-white">Expert Content</Text>
                        </View>
                    </Animated.View>
                    ...
                    <Animated.View
                        ...
                        className="mt-4"
                    >
                        <Text className="text-xs font-poppins text-white text-center">
